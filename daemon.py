...
HELP = (
    ...
    "\n"
    "Reactions — the only feedback a note gets, so they're worth knowing:\n"
    "👀 received · 👌 command started or answered · ✍ filed as an intent note · "
    "😱 nothing happened, and a reply says why."
)
